...
export function StepCard({ step }: StepCardProps) {
  return (
    <div className="relative rounded-2xl border border-border bg-white p-6">
      <span className="font-inter text-4xl font-bold text-primary/15">{step.step}</span>
      <div className="mt-3 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-primary text-primary-foreground">
        {step.icon}
      </div>
