...
function buildRoadmapReasoningFallback(
  ...
  return [
    ...
    "Saran dari AI: tetap konsisten belajar sedikit demi sedikit setiap hari, dan jangan ragu mengulangi materi yang terasa sulit sebelum lanjut ke fase berikutnya. AI bisa membuat kesalahan. Tetap lakukan riset dan verifikasi informasi yang diberikan.",
  ].join(" ");
}
...
function buildBatchReasoningFallback(
  ...
  return [
    ...
    "Saran dari AI: kerjakan task sesuai urutan sedikit demi sedikit, dan luangkan waktu praktik langsung supaya materinya semakin nempel. AI bisa membuat kesalahan. Tetap lakukan riset dan verifikasi informasi yang diberikan.",
  ].join(" ");
}
